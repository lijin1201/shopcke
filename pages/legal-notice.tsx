...
import htmlContent from "public/static/terms-and-conditions.html";
...
<li className="flex flex-col gap-5">
  <strong className="indent-0">
    Article 9 (Application for purchase and consent to provision of
    personal information, etc.)
  </strong>
  <ol className="list-decimal">
    <li>
      A user of the “mall” applies for a purchase in the “mall” by the
      following or similar methods, and the “mall” shall provide each
      of the following information in an easy-to-understand manner to
      the user when applying for a purchase.
      <ol className="list-decimal ml-4">
        <li>Search and selection of goods, etc.</li>
        <li>
          Input of the recipient's name, address, phone number, e-mail
